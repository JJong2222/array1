...
public class ArrayEx1 {
	public static void main(String[] args) {
		...
		// int형 데이터를 저장 할 수 있는 배열 arr1를 선언 했다.
		//	int arr2[]=new int[5]; // 9열과 같음
		int[] arr1=new int[5];
		// 초기화
//		arr1[0]=1;
//		arr1[1]=2;
...
//		System.out.println(arr1[4]);
		// for문을 이용해서 arr1를 01234로 초기화 하고 콘솔에 각 번지의 값을 출력 해보세요.
		// 변하는 값은 변수에 설정, 변하지 않는 것은 문자열
		...
		// int형 데이터를 저장 할 수 있는 배열 arr3을 선언 하고 int형 12345로 초기화 했다.
